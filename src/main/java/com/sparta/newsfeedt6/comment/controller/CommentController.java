...
public class CommentController {
    ...
    public ResponseEntity<CommentResponseDto> createComment(@PathVariable Long postId, CommentRequestDto requestDto,
    ...
    public ResponseEntity<CommentResponseDto> updateComment(@PathVariable Long commentId, CommentEditRequestDto requestDto,
                                                            @AuthenticationPrincipal UserDetailsImpl userDetails) {
